...
// ====== SERVER OTA PUBLIC (GitHub RAW) ======
const char *OTA_BASE_URL = "https://raw.githubusercontent.com/<USERNAME>/<REPO>/main/";
...
// === Hàm kiểm tra version.json trên GitHub ===
void checkForUpdate()
{
  ...
  HTTPClient httpVer;
  String versionUrl = String(OTA_BASE_URL) + VERSION_FILE;
